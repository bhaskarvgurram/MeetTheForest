...
export var track = [{
    ...
    docusign_messages: ["Would you like to save me from the deforestration and senseless mining, drilling and land clearing activities. My health is deteriorating."],
    image:require('../js/res/sentinal.jpg')
}, {
    latitude: "35.7908536",
    ...
    image:require('../js/res/bridge.jpg')
...
export var visitingSpots = [
    ...
    },
    {
        ...
        image:require('../js/res/swinging.jpg')
    ...
    },
    {
        ...
        docusign_messages: ["You can help me by signing this petition."],
        image:require('../js/res/chappal.jpg')
